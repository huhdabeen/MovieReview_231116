...
public class InsertBoardCommand {
	...
	public InsertBoardCommand(String id, @NotBlank(message = "제목을 입력하세요") String title,
			@NotBlank(message = "내용을 입력하세요") String content, @NotBlank(message = "영화를 선택하세요") String movie_nm) {
		super();
		this.id = id;
		this.title = title;
	...
	public String toString() {
		return "InsertBoardCommand [id=" + id + ", title=" + title + ", content=" + content + ", movie_nm=" + movie_nm
				+ "]";
	}
